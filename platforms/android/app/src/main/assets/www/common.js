...
var ListasComponent = /** @class */ (function () {
    function ListasComponent(deseosService, router, alertCtrl) {
    ...
    ListasComponent.prototype.editarLista = function (lista) {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonList"]),
    ...
    ListasComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./listas.component.scss */ "./src/app/components/listas/listas.component.scss")]
        }),
...
var FiltroCompletadoPipe = /** @class */ (function () {
    ...
    FiltroCompletadoPipe.prototype.transform = function (listas, completada) {
        if (completada === void 0) { completada = true; }
        return listas.filter(function (lista) { return lista.terminada === completada; });
    };
...
var DeseosService = /** @class */ (function () {
    ...
    DeseosService.prototype.crearLista = function (titulo) {
    ...
    DeseosService.prototype.borrarLista = function (lista) {
        this.listas = this.listas.filter(function (listaData) { return listaData.id !== lista.id; });
        this.guardarStorage();
    };
    DeseosService.prototype.obtenerLista = function (id) {
        id = Number(id);
        return this.listas.find(function (listaData) { return listaData.id === id; });
    };
